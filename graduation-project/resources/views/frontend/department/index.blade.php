    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="teachers-tab" data-toggle="tab" href="#teachers" role="tab" aria-controls="teachers"
                aria-selected="false">Teaching Staff</a>
        </li>
        <li class="nav-item" role="presentation">
                ...
                <div class="row">
                    ...
                    <div class="p-3 teacher-card">
                        <a class="text-decoration-none" href="{{ route('teacher.show', $teacher->name) }}">
                            @if ($teacher->image)
                            <img style="width:150px; hieght:150px;" src="{{ asset($teacher->image) }}" class="rounded teachers-image mb-2 mx-auto" alt="">
                            @else
                            <img style="width:150px; hieght:150px;" src="{{ asset('images/avatar.png') }}" class="rounded teachers-image mb-2 mx-auto"
                                alt="">
                            @endif
                            <h6 class="text-dark text-capitalize text-center">{{ $teacher->name }}</h6>
                        </a>
                    </div>
                    @endforeach
